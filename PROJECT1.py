#Ülesanne 14
ppl=int(input("Введите общее количество людей: "))
bus=int(input("Введите размер автобуса (вместимость): "))
nbus=ppl/bus
rppl=ppl%bus
print(f"Для перевозки {ppl} человек(а) в автобусах вместимостью {bus} человек(а):")
    print(f"Необходимо {nbus} автобусов.")
    print(f"В последнем автобусе будет {rppl} человек(а).")
